...
function SideNav() {
    ...
    return (
        <div className="border shadow-md h-screen p-2">
            ...
            <div className='flex  gap-2 items-start bottom-5 fixed py-4 '>
                <Image src={user?.picture || "https://lh3.googleusercontent.com/a/ACg8ocKJJUee2JkuCGQbDFGKcRKq-bohrFqZYCeLW8NqxSyVfvz0cw=s96-c"} width={35}
                height={35}
                alt='user'
